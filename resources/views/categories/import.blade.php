        ...
        <div class="content">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="mt-2">Please ensure your file has the following columns in the first row (heading):
                        <strong>name, parent_category_name</strong>.</p>
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul>
                            ...
                            <li>For sub-categories, provide the exact name of an existing category in the
                                <strong>parent_category_name</strong> column.</li>
                    ...
                    <form action="{{ route('categories.import.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('category_file') is-invalid @enderror" type="file"
                                id="category_file" name="category_file" required>
                            @error('category_file')
