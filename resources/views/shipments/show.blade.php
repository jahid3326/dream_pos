                        ...
                        <div class="col-lg-8 ps-lg-4 py-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="fw-bold summary-value">
                                        {{ optional($shipment->shippingType)->name ?? ($shipment->type_shipping1 ?? 'N/A') }}
                                        @if (optional($shipment->shippingTax)->name)
                                            <small class="text-muted d-block">({{ $shipment->shippingTax->name }})</small>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
