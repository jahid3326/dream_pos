    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                @if(isset($user))<small class="form-text text-muted">Leave blank to keep the current password.</small>@endif
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $user->profile_picture) }}" alt="Current Picture" width="100">
                </div>
                @endif
            </div>
        </div>
