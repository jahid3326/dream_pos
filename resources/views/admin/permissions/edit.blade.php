            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('admin.permissions.update', $role->id) }}" method="POST">
                        ...
                        <p class="text-muted small">Note: A user must have access to a parent (Header/Dropdown) to see the
                            children within it.</p>
                        ...
                        <div class="list-group">
                            ...
                            @foreach ($allNavItems as $navItem)
                                @include('admin.permissions._nav_item_permission_checkbox', [
                                    'item' => $navItem,
                                    'level' => 0,
                                ])
                            @endforeach
