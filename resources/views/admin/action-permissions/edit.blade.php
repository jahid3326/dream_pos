                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><input class="form-check-input" type="checkbox" name="permissions[{{$model}}][create]" value="1" {{ $p?->can_create ? 'checked' : '' }}></td>
                                <td class="text-center"><input class="form-check-input" type="checkbox" name="permissions[{{$model}}][read]" value="1" {{ $p?->can_read ? 'checked' : '' }}></td>
                                
                                {{-- NEW CHECKBOX CELL FOR SHOW --}}
                                <td class="text-center"><input class="form-check-input" type="checkbox" name="permissions[{{$model}}][show]" value="1" {{ $p?->can_show ? 'checked' : '' }}></td>

                                <td class="text-center"><input class="form-check-input" type="checkbox" name="permissions[{{$model}}][update]" value="1" {{ $p?->can_update ? 'checked' : '' }}></td>
                                <td class="text-center"><input class="form-check-input" type="checkbox" name="permissions[{{$model}}][delete]" value="1" {{ $p?->can_delete ? 'checked' : '' }}></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
