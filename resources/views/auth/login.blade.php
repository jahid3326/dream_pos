...
<html lang="en">
    <head>
		...
		<title>Dreams POS - Sign In</title>
        ...
        <div class="main-wrapper">
			<div class="account-content">
				<div class="row login-wrapper m-0">
                                ...
                                <div class="login-userset">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group login-email">
                                            <input id="email" type="email" name="email" value="{{ old('email') }}" class="form-control border-end-0 @error('email') is-invalid @enderror">
                                            <span class="input-group-text border-start-0 @error('email') is-icon-invalid @enderror">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="pass-group login-password">
                                            <input id="password" type="password" name="password" class="pass-input form-control @error('password') is-invalid @enderror" autocomplete="off">
                    ...
                    <div class="col-lg-6 p-0">
                        <div class="login-img">
                            <img src="{{ asset('public/assets/img/authentication/authentication-01.svg') }}" alt="img">
                        </div>
                    </div>
                </div>
			</div>
