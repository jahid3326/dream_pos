            ...
            <div class="card-body">
                ...
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>The <strong>email</strong> for each customer must be unique.</li>
                ...
                <form action="{{ route('customers.import.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="customer_file" class="form-label">Customer File</label>
                        <input class="form-control @error('customer_file') is-invalid @enderror" type="file" id="customer_file" name="customer_file" required>
                        @error('customer_file')
