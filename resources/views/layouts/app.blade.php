					...
					<ul class="nav user-menu">
								...
								<form action="#" class="dropdown">
									<div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="outside">
										...
										<span class="input-group-text">
											<kbd class="d-flex align-items-center"><img src="{{ asset('public/assets/img/icons/command.svg') }}" alt="img" class="me-1">K</kbd>
										</span>
									</div>
									<div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
										...
										<div class="search-info">
											...
											<ul class="customers">
												<li><a href="javascript:void(0);">Aron Varu<img src="{{ asset('public/assets/img/profiles/avator1.jpg') }}" alt="Img" class="img-fluid"></a></li>
												<li><a href="javascript:void(0);">Jonita<img src="{{ asset('public/assets/img/profiles/avatar-01.jpg') }}" alt="Img" class="img-fluid"></a></li>
												<li><a href="javascript:void(0);">Aaron<img src="{{ asset('public/assets/img/profiles/avatar-10.jpg') }}" alt="Img" class="img-fluid"></a></li>
											</ul>
										</div>
									</div>
								</form>
						...
						<li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
							<a href="javascript:void(0);" class="dropdown-toggle nav-link select-store"
								...
								<span class="user-info">
									<span class="user-letter">
										<img src="{{ asset('public/assets/img/store/store-01.png') }}" alt="Store Logo" class="img-fluid">
									</span>
							...
							<div class="dropdown-menu dropdown-menu-right">
								<a href="javascript:void(0);" class="dropdown-item">
									<img src="{{ asset('public/assets/img/store/store-01.png') }}" alt="Store Logo" class="img-fluid">Freshmart
								</a>
								<a href="javascript:void(0);" class="dropdown-item">
									<img src="{{ asset('public/assets/img/store/store-02.png') }}" alt="Store Logo" class="img-fluid">Grocery Apex
								</a>
								<a href="javascript:void(0);" class="dropdown-item">
									<img src="{{ asset('public/assets/img/store/store-03.png') }}" alt="Store Logo" class="img-fluid">Grocery Bevy
								</a>
								<a href="javascript:void(0);" class="dropdown-item">
									<img src="{{ asset('public/assets/img/store/store-04.png') }}" alt="Store Logo" class="img-fluid">Grocery Eden
								</a>
							</div>
						</li>
						<!-- /Select Store -->
						...
						<li class="nav-item dropdown has-arrow flag-nav nav-item-box">
							<a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
								role="button">
								<img src="{{ asset('public/assets/img/flags/us-flag.svg') }}" alt="Language" class="img-fluid">
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<a href="javascript:void(0);" class="dropdown-item">
									<img src="{{ asset('public/assets/img/flags/english.svg') }}" alt="Img" height="16">English
								</a>
								<a href="javascript:void(0);" class="dropdown-item">
									<img src="{{ asset('public/assets/img/flags/arabic.svg') }}" alt="Img" height="16">Arabic
								</a>
							</div>
						</li>
						<!-- /Flag -->
									...
									<ul class="notification-list">
											...
											<a href="activities.html">
												<div class="media d-flex">
													<span class="avatar flex-shrink-0">
														<img alt="Img" src="{{ asset('public/assets/img/profiles/avatar-13.jpg') }}">
													</span>
										...
										<li class="notification-message">
											<a href="activities.html">
												<div class="media d-flex">
													<span class="avatar flex-shrink-0">
														<img alt="Img" src="{{ asset('public/assets/img/profiles/avatar-03.jpg') }}">
													</span>
													<div class="flex-grow-1">
										...
										<li class="notification-message">
											<a href="activities.html" class="recent-msg">
												<div class="media d-flex">
													<span class="avatar flex-shrink-0">
														<img alt="Img" src="{{ asset('public/assets/img/profiles/avatar-17.jpg') }}">
													</span>
													<div class="flex-grow-1">
										...
										<li class="notification-message">
											<a href="activities.html" class="recent-msg">
												<div class="media d-flex">
													<span class="avatar flex-shrink-0">
														<img alt="Img" src="{{ asset('public/assets/img/profiles/avatar-02.jpg') }}">
													</span>
													<div class="flex-grow-1">
						...
						<li class="nav-item dropdown has-arrow main-drop profile-nav">
							<a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
								<span class="user-info p-0">
									<span class="user-letter">
										<img src="{{ asset('public/assets/img/profiles/avator1.jpg') }}" alt="Img" class="img-fluid">
									</span>
								</span>
							</a>
				...
				<div class="modern-profile p-3 pb-0">
					<div class="text-center rounded bg-light p-3 mb-4 user-profile">
						<div class="avatar avatar-lg online mb-3">
							<img src="{{ asset('public/assets/img/customer/customer15.jpg') }}" alt="Img" class="img-fluid rounded-circle">
						</div>
												...
												@foreach ($navItem->children->sortBy('order') as $child)
													...
													@if ($child->type === 'dropdown' && $child->children->count() > 0)
														@php
															...
															$isSubmenuActive = $child->children->pluck('route')->contains(function ($route) use ($currentRouteName) {
																if (empty($route)) return false; // Safety check
																$moduleName = explode('.index', $route)[0];
																return \Illuminate\Support\Str::startsWith($currentRouteName, $moduleName);
															});
														@endphp
														<li class="submenu">
															<a href="javascript:void(0);" class="{{ $isSubmenuActive ? 'subdrop active' : '' }}">
																<i class="ti {{ $child->icon }} fs-16 me-2"></i><span>{{ $child->name }}</span><span class="menu-arrow"></span>
															</a>
															<ul>
																@foreach ($child->children->sortBy('order') as $grandchild)
																	@php
																		if (empty($grandchild->route)) continue; // Safety check
																		$moduleName = explode('.index', $grandchild->route)[0];
																		$isGrandchildActive = \Illuminate\Support\Str::startsWith($currentRouteName, $moduleName);
																	@endphp
																	<li class="{{ $isGrandchildActive ? 'active' : '' }}">
																		<a href="{{ route($grandchild->route) }}">{{ $grandchild->name }}</a>
																	</li>
																@endforeach
															</ul>
														</li>
													...
													@elseif ($child->type === 'link' && $child->route)
														@php
															...
															$isLinkActive = \Illuminate\Support\Str::startsWith($currentRouteName, $moduleName);
														@endphp
														<li class="{{ $isLinkActive ? 'active' : '' }}">
															<a href="{{ route($child->route) }}">
																<i class="ti {{ $child->icon }} fs-16 me-2"></i><span>{{ $child->name }}</span>
															</a>
														</li>
													@endif
												@endforeach
