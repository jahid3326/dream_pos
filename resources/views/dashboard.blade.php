...
<div class="page-wrapper">
    ...
    <div class="welcome-wrap mb-4">
        ...
        <div class="welcome-bg">
            <img src="{{ asset('public/assets/img/bg/welcome-bg-02.svg') }}" alt="img" class="welcome-bg-01">
            <img src="{{ asset('public/assets/img/bg/welcome-bg-01.svg') }}" alt="img" class="welcome-bg-03">
        </div>
    </div>	
    <!-- /Welcome Wrap -->
            ...
            <div class="card flex-fill">
                ...
                <div class="card-body pb-2">
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                         
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/company/company-02.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                           
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/company/company-03.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                           
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/company/company-05.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                        
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/company/company-07.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-1">
                        <div class="d-flex align-items-center mb-2">                                           
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/company/company-08.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
            ...
            <div class="card flex-fill">
                ...
                <div class="card-body pb-2">
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                            
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/icons/company-icon-11.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                                   
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/icons/company-icon-12.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                                
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/icons/company-icon-13.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center mb-2">                                                   
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/icons/company-icon-14.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-sm-flex justify-content-between flex-wrap mb-1">
                        <div class="d-flex align-items-center mb-2">                                                    
                            <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                <img src="{{ asset('public/assets/img/icons/company-icon-15.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                ...
                <div class="card-body pb-2">
                    <div>
                        <div class="d-sm-flex align-items-center justify-content-between flex-wrap mb-3">
                            <div class="d-flex align-items-center mb-2">                                            
                                <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                    <img src="{{ asset('public/assets/img/icons/company-icon-16.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                                </a>
                                <div class="ms-2 flex-fill">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between flex-wrap mb-3">
                            <div class="d-flex align-items-center mb-2">                                      
                                <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                    <img src="{{ asset('public/assets/img/icons/company-icon-18.svg') }}" class="img-fluid w-auto h-auto" alt="img">
                                </a>
                                <div class="ms-2 flex-fill">
