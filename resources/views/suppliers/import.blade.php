            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('suppliers.import.sample') }}" class="btn btn-sm btn-outline-info">
                    ...
                    <form action="{{ route('suppliers.import.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('supplier_file') is-invalid @enderror" type="file"
                                id="supplier_file" name="supplier_file" required>
                            @error('supplier_file')
