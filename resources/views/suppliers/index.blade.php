                ...
                <div class="page-btn">
                    @if (hasActionPermission('Supplier', 'create'))
                        <a href="{{ route('suppliers.create') }}" class="btn btn-primary"><i
                                class="ti ti-circle-plus me-1"></i>Add New Supplier</a>
                        ...
                        <div class="d-flex table-dropdown my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu  dropdown-menu-end p-3">
                                    <li>
                                        <a href="{{ route('suppliers.index', ['status' => '1', 'search' => request('search')]) }}"
                                            class="dropdown-item rounded-1">Enabled</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('suppliers.index', ['status' => '0', 'search' => request('search')]) }}"
                                            class="dropdown-item rounded-1">Disabled</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('suppliers.index', ['search' => request('search')]) }}"
                            ...
                            <tbody>
                                @foreach ($suppliers as $supplier)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="d-inline-flex align-items-center p-1 pe-2 rounded-1 text-white {{ $supplier->status == 1 ? 'bg-success' : 'bg-danger' }} fs-10"><i
                                                    class="ti ti-point-filled me-1 fs-11"></i>{{ $supplier->status == 1 ? 'Enabled' : 'Disabled' }}</span>
                                        </td>
                                        @if (hasActionPermission('Supplier', 'update') || hasActionPermission('Supplier', 'delete'))
                                            <td class="d-flex">
