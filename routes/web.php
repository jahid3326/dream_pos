...
use App\Http\Controllers\Settings\ShippingTaxController;
use App\Http\Controllers\Settings\ShippingTypeController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::middleware(['nav.permission'])->group(function () {
            ...
            Route::resource('shipping-taxes', ShippingTaxController::class);
