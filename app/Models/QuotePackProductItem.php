...
class QuotePackProductItem extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'quote_pack_product_items';
     ...
     */
    public function quotePackProduct()
    {
        return $this->belongsTo(QuotePackProduct::class);
    }
